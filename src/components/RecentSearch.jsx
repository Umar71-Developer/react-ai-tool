          ...
          {recentHistory &&
            recentHistory.map((item, index) => (
              ...
              <li
                ...
                className="w-full p-0.5 pl-5 cursor-pointer dark:text-zinc-400 text-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-200 truncate hover:bg-red-200 hover:text-zinc-800"
                key={index + Math.random()}
              >
                {item}
              </li>
              <button onClick={() => clearSelectedHistory(item)} className="cursor-pointer bg-zinc-700 hover:bg-zinc-900">
            <svg 
